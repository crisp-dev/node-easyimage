...
//         return easyimg.convert({src:srcimg, dst: __dirname + '/output/convert.png', quality:10}).then(function (fileName) {
...
//             return easyimg.rotate({src:srcimg, dst: __dirname + '/output/rotated.jpg', degree: 90}).then(function (fileName) {
//                 fileName.should.be.a('string');
//             });
//         })
//     });
...
//         return easyimg.resize({src:srcimg, dst: __dirname + '/output/resize.jpg', width:640, height:400}).then(function (fileName) {
//             fileName.should.be.a('string');
//         });
...
//         return easyimg.resize({src:srcimg, dst: __dirname + '/output/resize.jpg', width:640, height:400, ignoreAspectRatio: true}).then(function (fileName) {
//             fileName.should.be.a('string');
//         });
